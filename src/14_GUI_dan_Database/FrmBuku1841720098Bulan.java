...
public class FrmBuku1841720098Bulan extends javax.swing.JFrame {
    /**
     * Creates new form FrmBuku
     */
    public FrmBuku1841720098Bulan() {
        initComponents();
        tampilkanDataBulan();
        tampilkanCmbKategoriBulan();
        kosongkanFormBulan();
    ...
    public void tampilkanDataBulan(){
        ...
        ArrayList<Buku1841720098Bulan> list = new Buku1841720098Bulan().getAll();
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            rowData[1] = list.get(i).getKategori().getNamaBulan();
    ...
    public void cari(String keyword){
        String[] kolom = {"ID" ,"Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Buku1841720098Bulan> list = new Buku1841720098Bulan().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));

        for (Buku1841720098Bulan buku : list) {
            rowData[0] = buku.getIdbuku();
            rowData[1] = buku.getKategori().getNamaBulan();
    ...
    public void tampilkanCmbKategoriBulan(){
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1841720098Bulan().getAllBulan().toArray()));
    }
    /**
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        buku.setKategori((Kategori1841720098Bulan)cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1841720098Bulan buku = new Buku1841720098Bulan().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanFormBulan();
        tampilkanDataBulan();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuku1841720098Bulan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1841720098Bulan().setVisible(true);
            }
        });
    }
